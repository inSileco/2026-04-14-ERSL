...
Our latest template uses [Quarto](https://quarto.org/), see https://quarto.org/docs/presentations/revealjs/.

To see the demo from the root of this repository, do: 

```sh
quarto preview quarto/insil/index.Qmd
quarto render quarto/insil/index.Qmd
```
...
Once the `icon` package has been installed, you will have to download icons libraries.
